	...
	<algorithm-wrapper class="algorithms-default-boundaries">
		<template v-slot:content>
			<div class="algorithms-default-boundaries__area" ref="container">
				<dynamic-cropper class="algorithms-default-boundaries__cropper" ref="cropper" :style="areaStyle" @resize="onResizeArea">
					<static-boundaries class="algorithms-default-boundaries__boundaries" :style="boundariesStyle"></static-boundaries>
				</dynamic-cropper>
			</div>
